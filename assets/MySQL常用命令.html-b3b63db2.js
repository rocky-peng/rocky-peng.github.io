import{_ as n,$ as e,a0 as i,a3 as s}from"./framework-68ade679.js";const a={},d=s(`<h2 id="常用语句" tabindex="-1"><a class="header-anchor" href="#常用语句" aria-hidden="true">#</a> 常用语句</h2><h3 id="select语句" tabindex="-1"><a class="header-anchor" href="#select语句" aria-hidden="true">#</a> SELECT语句</h3><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>当前登录用户
select user();
