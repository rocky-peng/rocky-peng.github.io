...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629082506340.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><h3 id="拷贝物理文件到新集群" tabindex="-1"><a class="header-anchor" href="#拷贝物理文件到新集群" aria-hidden="true">#</a> 拷贝物理文件到新集群</h3><p>把es6.2.3的3节点数据分别拷贝到es7.4.1的3个data节点中。（为了避免cluster.uuid出现不一致，需先将新集群的data数据清空，然后先启动3个data节点，再启动master节点，观察es集群状态</p><p>再启动第4个data节点，观察es数据。然后停掉一个到多个data节点，观察es数据（es会自动重新分配数据的分配情况）</p><p>在启动一个master节点（模拟线上多个master的情况）</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629082515110.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><br>`,29),o=n("p",null,[n("br"),n("br"),n("br"),n("br"),n("br"),n("br")],-1),i=n("hr",null,null,-1),u=n("hr",null,null,-1),r=n("ul",null,[n("li",null,[n("strong",null,"随机毒鸡汤"),s("：每天都要开开心心的，这样，你就是个开心的废物了。 "),n("br"),n("br"),n("img",{src:"https://tuapi.eees.cc/api.php?category=biying&type=302&uuid=191ec0d0-e617-4481-bef1-0ba9c2b2536c",alt:"",loading:"lazy"})])],-1);function d(v,k){return t(),e("div",null,[c,s(" ## 系统推荐 - [常见问题](../../spring/常见问题.md) - [提取Docker镜像中的文件](../../../other/提取Docker镜像中的文件.md) - [Thread & ExecutorService & ThreadPoolExecutor 总览](../../java-basic/Thread & ExecutorService & ThreadPoolExecutor 总览.md) - [IO相关](../../java-basic/IO相关.md) - [istio基础知识](../../../other/istio基础知识.md) - [MySQL三大日志](../mysql/MySQL三大日志.md) - [Nginx的双向认证配置](../../../other/Nginx的双向认证配置.md) - [ESRally性能测试步骤](ESRally性能测试步骤.md) "),o,i,u,r])}const b=a(l,[["render",d],["__file","ES6.2.3(3节点)数据迁移到ES7.4.1(5节点).html.vue"]]);export{b as default};
