...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>WAL: 什么叫WAL，全称Write Ahead Log，也就是同一个事务的数据，日志的数据必须先于最终的数据落盘</li></ul><p><br><br><br><br><br><br></p><hr><hr><ul><li><strong>随机毒鸡汤</strong>：我捡了个神灯，许愿我死前能找到女朋友，结果我获得了永生。 <br><br><img src="https://api.btstu.cn/sjbz/?lx=suiji&amp;uuid=cea40d6f-ded3-4990-b988-a179fdaeb32b" alt="" loading="lazy"></li></ul>`,10);function m(b,h){const i=t("ExternalLinkIcon");return n(),d("div",null,[v,e("p",null,[e("a",o,[l("http://thesecretlivesofdata.com/raft/"),r(i)])]),u])}const _=a(c,[["render",m],["__file","raft协议.html.vue"]]);export{_ as default};
