import{_ as o,$ as c,a0 as r,a1 as n,a2 as s,a3 as a,a4 as t,a5 as p,w as l}from"./framework-4ae679b7.js";const u={},d=p(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">java</span> <span class="token parameter variable">-version</span>
...
Compiled  Size  Type Method
    ...
    <span class="token number">1074</span>    <span class="token number">191</span>    <span class="token number">1</span> redis/clients/util/RedisInputStream readLineBytes 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="其他选项" tabindex="-1"><a class="header-anchor" href="#其他选项" aria-hidden="true">#</a> 其他选项</h4>`,29),m={href:"http://docs.oracle.com/javase/7/docs/technotes/tools/share/jstat.html#options",target:"_blank",rel:"noopener noreferrer"},b=p(`<h2 id="jinfo" tabindex="-1"><a class="header-anchor" href="#jinfo" aria-hidden="true">#</a> jinfo</h2><p>主要用来查看和调整jvm参数。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@qa-service ~<span class="token punctuation">]</span><span class="token comment"># jinfo</span>
Usage:
