import{_ as i,$ as s,a0 as a,a2 as e,a4 as d,a1 as n}from"./framework-294a1fec.js";const l={},r=d(`<h2 id="常用语句" tabindex="-1"><a class="header-anchor" href="#常用语句" aria-hidden="true">#</a> 常用语句</h2><h3 id="select语句" tabindex="-1"><a class="header-anchor" href="#select语句" aria-hidden="true">#</a> SELECT语句</h3><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>当前登录用户
select user();
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br>`,76),v=n("p",null,[n("br"),n("br"),n("br"),n("br"),n("br"),n("br")],-1),c=n("hr",null,null,-1),t=n("hr",null,null,-1),u=n("ul",null,[n("li",null,[n("strong",null,"随机毒鸡汤"),e("：我从不去想何时能成功，既然选择了远方，那就还远着呢。 "),n("br"),n("br"),n("img",{src:"https://tuapi.eees.cc/api.php?category=biying&type=302&uuid=878ab523-c426-4313-96b4-d516cc211f4c",alt:"",loading:"lazy"})])],-1);function m(b,o){return s(),a("div",null,[r,e(" ## 系统推荐 - [MAT工具](../../unclassified/MAT工具.md) - [来个JVM冷知识](../../../other/来个JVM冷知识.md) - [Git合并多个提交并push到远程仓库](../../../other/Git合并多个提交并push到远程仓库.md) - [如何安装Google BBR](../../../other/如何安装Google BBR.md) - [JVM杂项](../../jvm/JVM杂项.md) - [Java语言完成notion笔记备份](../../../other/Java语言完成notion笔记备份.md) - [sofajraft](../../raft/sofajraft.md) - [PostgreSQL高可用](../../../other/PostgreSQL高可用.md) "),v,c,t,u])}const p=i(l,[["render",m],["__file","MySQL常用命令.html.vue"]]);export{p as default};
