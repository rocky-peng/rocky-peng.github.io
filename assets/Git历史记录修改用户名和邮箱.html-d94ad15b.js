import{_ as s,$ as n,a0 as a,a3 as e}from"./framework-7993f525.js";const t={},i=e(`<ol><li><p>进入仓库目录，执行</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">#!/bin/sh</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol><p><br><br><br><br><br><br></p><hr><hr><ul><li><strong>随机毒鸡汤</strong>：白天嘈杂得不愿意醒，夜晚安静得舍不得睡。 <br><br><img src="https://tuapi.eees.cc/api.php?category=fengjing&amp;type=302&amp;uuid=04602515-a084-4166-b58e-ff21de9151a7" alt="" loading="lazy"></li></ul>`,5),l=[i];function o(p,r){return n(),a("div",null,l)}const d=s(t,[["render",o],["__file","Git历史记录修改用户名和邮箱.html.vue"]]);export{d as default};
