import{_ as p,$ as t,a0 as l,a1 as n,a2 as s,a3 as i,a4 as a,w as o}from"./framework-294a1fec.js";const c={},r=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">java</span> <span class="token parameter variable">-version</span>
...
Compiled  Size  Type Method
    ...
    <span class="token number">1074</span>    <span class="token number">191</span>    <span class="token number">1</span> redis/clients/util/RedisInputStream readLineBytes 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="其他选项" tabindex="-1"><a class="header-anchor" href="#其他选项" aria-hidden="true">#</a> 其他选项</h4>`,29),u={href:"http://docs.oracle.com/javase/7/docs/technotes/tools/share/jstat.html#options",target:"_blank",rel:"noopener noreferrer"},d=a(`<h2 id="jinfo" tabindex="-1"><a class="header-anchor" href="#jinfo" aria-hidden="true">#</a> jinfo</h2><p>主要用来查看和调整jvm参数。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@qa-service ~<span class="token punctuation">]</span><span class="token comment"># jinfo</span>
Usage:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br>`,6),m=n("p",null,[n("br"),n("br"),n("br"),n("br"),n("br"),n("br")],-1),b=n("hr",null,null,-1),v=n("hr",null,null,-1),k=n("ul",null,[n("li",null,[n("strong",null,"随机毒鸡汤"),s("：誓言两个字都有口，偏偏有口无心。 "),n("br"),n("br"),n("img",{src:"https://tuapi.eees.cc/api.php?category=fengjing&type=302&uuid=0afa258d-4609-407d-9ce4-9c9e845fffc5",alt:"",loading:"lazy"})])],-1);function g(h,K){const e=o("ExternalLinkIcon");return t(),l("div",null,[r,n("p",null,[s("具体可以参考官网："),n("a",u,[s("http://docs.oracle.com/javase/7/docs/technotes/tools/share/jstat.html#options"),i(e)])]),d,s(" ## 系统推荐 - [Btrace入门](../unclassified/Btrace入门.md) - [NGINX](../unclassified/NGINX.md) - [如何安装Google BBR](../../other/如何安装Google BBR.md) - [Cornell Notes System](../../other/Cornell Notes System.md) - [Paxos算法](../../other/Paxos算法.md) - [Java语言完成notion笔记备份](../../other/Java语言完成notion笔记备份.md) - [PostgreSQL JSON类型字段常用操作](../../other/PostgreSQL JSON类型字段常用操作.md) - [Docker跨主机通信方案](../docker/Docker跨主机通信方案.md) "),m,b,v,k])}const C=p(c,[["render",g],["__file","JDK命令行工具.html.vue"]]);export{C as default};
