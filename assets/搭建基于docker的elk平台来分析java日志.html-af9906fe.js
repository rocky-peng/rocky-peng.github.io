...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上步骤搞定后，就可以爽歪歪的使用 kibana了。</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629081592042.jpg" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><p><br><br><br><br><br><br></p><hr><hr><ul><li><strong>随机毒鸡汤</strong>：很喜欢滴滴司机说的一句话，你搞清楚自己的定位没有？ <br><br><img src="https://tuapi.eees.cc/api.php?category=dongman&amp;type=302&amp;uuid=3deeacf8-216a-4522-9c9e-531cbdd02817" alt="" loading="lazy"></li></ul>`,8);function f(k,_){const n=r("ExternalLinkIcon");return d(),a("div",null,[v,i("p",null,[e("这样更改后，通过filebeat的multiline解决了日志分割的问题。 下面需要解决日志json化的问题：关键点：grok表达式。 这个表达式的学习完全没有必要从头开始学或者系统的学习，我完全是依葫芦画瓢学习的。这里举一个非常简单的例子体验一下： 网址："),i("a",o,[e("http://grokdebug.herokuapp.com/"),s(n)]),e(" 或者 "),i("a",c,[e("http://grok.elasticsearch.cn/"),s(n)]),e(" 在input输入：")]),m,i("p",null,[e("可参照官网安装步骤："),i("a",b,[e("https://docs.docker.com/install/linux/docker-ce/centos/"),s(n)])]),g,i("p",null,[e("安装方法可以参照官网： "),i("a",p,[e("https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-installation.html"),s(n)])]),q,i("p",null,[e("启动filebeat: 不同系统的启动方法有所不同，具体可以参照官网： "),i("a",h,[e("https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-starting.html"),s(n)])]),x])}const j=t(u,[["render",f],["__file","搭建基于docker的elk平台来分析java日志.html.vue"]]);export{j as default};
