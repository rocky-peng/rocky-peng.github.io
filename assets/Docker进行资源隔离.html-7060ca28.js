import{_ as e,$ as i,a0 as n,a3 as s}from"./framework-d23ee599.js";const a={},r=s(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>其实docker命令已经给我们使用文档了，不必进行网上搜索。</p><p>比如执行：docker run --help 可以看到</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>➜  ~ docker run --help                                                                                 
