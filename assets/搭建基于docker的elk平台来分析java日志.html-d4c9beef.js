...
error2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看出，如果以空白行区分，不但会把原本属于同一个日志事件的日志分开，还会把不属于同一个日志事件的日志误认为属于同一个日志事件。</p><p>当然这个问题也可以解决，后来折腾半天发现为啥子要以空白行分割嘛，直接把分区日志事件的逻辑改为：已日期开头的日志属于新的一个日志，就完美解决这个问题了。（给自己有个白眼🙄）</p>`,25),v={href:"http://grokdebug.herokuapp.com/",target:"_blank",rel:"noopener noreferrer"},c={href:"http://grok.elasticsearch.cn/",target:"_blank",rel:"noopener noreferrer"},m=l(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>2018-12-21 16:00:54,774 INFO c.l.c.w.l.AccessLog [AuthAndAccessLogAop.java:191] {&quot;request&quot;:{&quot;headers&quot;:{&quot;Accept&quot;:&quot;*/*&quot;,&quot;Connection&quot;:&quot;close&quot;,&quot;User-Agent&quot;:&quot;Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)&quot;,&quot;Accept-Language&quot;:&quot;zh-cn&quot;},&quot;params&quot;:{},&quot;uri&quot;:&quot;/api/test/echo&quot;,&quot;method&quot;:&quot;GET&quot;,&quot;time&quot;:&quot;2018-12-21 16:00:54&quot;},&quot;response&quot;:{&quot;msg&quot;:&quot;success&quot;,&quot;data&quot;:[1,2,3]},&quot;checkTokenTime&quot;:0,&quot;controllerTime&quot;:2}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到此，方案二结束。接下来我们来安装elk实施日志分析。</p><h2 id="在centos7上安装docker" tabindex="-1"><a class="header-anchor" href="#在centos7上安装docker" aria-hidden="true">#</a> 在centos7上安装docker</h2>`,32),b={href:"https://docs.docker.com/install/linux/docker-ce/centos/",target:"_blank",rel:"noopener noreferrer"},g=l(`<p>也可执行以下步骤：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>移除旧版本：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到此，elk服务准备好了，下一步使用filebeat搜集日志。</p><h2 id="安装filebeat" tabindex="-1"><a class="header-anchor" href="#安装filebeat" aria-hidden="true">#</a> 安装filebeat</h2><p>下面需要在日志所在的机子上安装filebeat。</p>`,27),p={href:"https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-installation.html",target:"_blank",rel:"noopener noreferrer"},q=l(`<p>因为这里是centos 7系统，我的安装步骤是：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>curl -L -O https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-5.4.3-x86_64.rpm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),h={href:"https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-starting.html",target:"_blank",rel:"noopener noreferrer"},x=l(`<p>我这里执行以下命令：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>启动：
sudo /etc/init.d/filebeat start 

停止：
sudo /etc/init.d/filebeat stop
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上步骤搞定后，就可以爽歪歪的使用 kibana了。</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629081592042.jpg" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><br>`,5),f=e("p",null,[e("br"),e("br"),e("br"),e("br"),e("br"),e("br")],-1),k=e("hr",null,null,-1),_=e("hr",null,null,-1),y=e("ul",null,[e("li",null,[e("strong",null,"随机毒鸡汤"),i("：99%的努力，也不及1%的幸运。 "),e("br"),e("br"),e("img",{src:"https://tuapi.eees.cc/api.php?category=biying&type=302&uuid=b0a36a83-683b-4ef6-9585-a5a0e3e32a98",alt:"",loading:"lazy"})])],-1);function j(w,T){const n=r("ExternalLinkIcon");return d(),a("div",null,[o,e("p",null,[i("这样更改后，通过filebeat的multiline解决了日志分割的问题。 下面需要解决日志json化的问题：关键点：grok表达式。 这个表达式的学习完全没有必要从头开始学或者系统的学习，我完全是依葫芦画瓢学习的。这里举一个非常简单的例子体验一下： 网址："),e("a",v,[i("http://grokdebug.herokuapp.com/"),s(n)]),i(" 或者 "),e("a",c,[i("http://grok.elasticsearch.cn/"),s(n)]),i(" 在input输入：")]),m,e("p",null,[i("可参照官网安装步骤："),e("a",b,[i("https://docs.docker.com/install/linux/docker-ce/centos/"),s(n)])]),g,e("p",null,[i("安装方法可以参照官网： "),e("a",p,[i("https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-installation.html"),s(n)])]),q,e("p",null,[i("启动filebeat: 不同系统的启动方法有所不同，具体可以参照官网： "),e("a",h,[i("https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-starting.html"),s(n)])]),x,i(" ## 系统推荐 - [Cordova+Umi项目搭建步骤](../../unclassified/Cordova+Umi项目搭建步骤.md) - [MongoDB高可用](../../../other/MongoDB高可用.md) - [Redis高可用](../../../other/Redis高可用.md) - [SQL优化](../mysql/SQL优化.md) - [Lombok的Accessors导致EasyExcel读取失败](../../../other/Lombok的Accessors导致EasyExcel读取失败.md) - [Java面试基础](../../java-basic/Java面试基础.md) - [免费 API 每日提供摸鱼日报，自动返回无水印图片，适用于公众号和小程序](../../../other/免费 API 每日提供摸鱼日报，自动返回无水印图片，适用于公众号和小程序.md) - [Hbase 总览](../../../other/Hbase 总览.md) "),f,k,_,y])}const A=t(u,[["render",j],["__file","搭建基于docker的elk平台来分析java日志.html.vue"]]);export{A as default};
