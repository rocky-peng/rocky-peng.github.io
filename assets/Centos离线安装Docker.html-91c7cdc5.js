import{_ as s,$ as a,a0 as d,a1 as e,a2 as n,a4 as r,a3 as l,w as t}from"./framework-6dd3436e.js";const c={},o=e("h2",{id:"下载离线安装包",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#下载离线安装包","aria-hidden":"true"},"#"),n(" 下载离线安装包")],-1),v={href:"https://download.docker.com/linux/static/stable/x86_64/",target:"_blank",rel:"noopener noreferrer"},u=l(`<p>这里选择了 docker-19.03.12.tgz</p><h2 id="禁用selinux" tabindex="-1"><a class="header-anchor" href="#禁用selinux" aria-hidden="true">#</a> 禁用SELinux</h2><p>如果不禁用的话，本人遇到过如下问题：在开启防火墙的情况下，执行systemctl start docker 卡死。 关闭防火墙后，上面的命令就能正常启动</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vi</span> /etc/selinux/config   
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><br><br><br><br><br><br></p><hr><hr><ul><li><strong>随机毒鸡汤</strong>：我们的欲望各不相同，但是失望的样子，却一模一样。 <br><br><img src="https://api.btstu.cn/sjbz/?lx=dongman&amp;uuid=7202e054-f2a5-4907-973f-9c2fcab631cc" alt="" loading="lazy"></li></ul>`,14);function m(b,h){const i=t("ExternalLinkIcon");return a(),d("div",null,[o,e("p",null,[n("下载地址： "),e("a",v,[n("https://download.docker.com/linux/static/stable/x86_64/"),r(i)])]),u])}const x=s(c,[["render",m],["__file","Centos离线安装Docker.html.vue"]]);export{x as default};
