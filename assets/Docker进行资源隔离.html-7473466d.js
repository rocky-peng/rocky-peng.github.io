import{_ as n,$ as s,a0 as a,a2 as i,a4 as d,a1 as e}from"./framework-294a1fec.js";const t={},r=d(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>其实docker命令已经给我们使用文档了，不必进行网上搜索。</p><p>比如执行：docker run --help 可以看到</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>➜  ~ docker run --help                                                                                 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到内存降到了500m内</p><br>`,29),l=e("p",null,[e("br"),e("br"),e("br"),e("br"),e("br"),e("br")],-1),o=e("hr",null,null,-1),c=e("hr",null,null,-1),u=e("ul",null,[e("li",null,[e("strong",null,"随机毒鸡汤"),i("：收藏从未停止，学习从未开始。 "),e("br"),e("br"),e("img",{src:"https://tuapi.eees.cc/api.php?category=biying&type=302&uuid=dbadec0b-759d-4417-b6a4-4c0cb43a025b",alt:"",loading:"lazy"})])],-1);function v(m,p){return s(),a("div",null,[r,i(" ## 系统推荐 - [Git笔记](../unclassified/Git笔记.md) - [ShadowsockServerUpdatePort](../shodowsocks/ShadowsockServerUpdatePort.md) - [制作KVM ES镜像文件](../unclassified/制作KVM ES镜像文件.md) - [简易版配置中心&初探原理](../unclassified/简易版配置中心&初探原理.md) - [SQL优化](../middleware/mysql/SQL优化.md) - [分布式事务Seata](../middleware/mysql/分布式事务Seata.md) - [SpringBoot服务在服务启动完成前被提前注册到nacos](../../other/SpringBoot服务在服务启动完成前被提前注册到nacos.md) - [intro](../../intro.md) "),l,o,c,u])}const h=n(t,[["render",v],["__file","Docker进行资源隔离.html.vue"]]);export{h as default};
