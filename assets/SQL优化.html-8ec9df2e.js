...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="sql使用技巧" tabindex="-1"><a class="header-anchor" href="#sql使用技巧" aria-hidden="true">#</a> SQL使用技巧</h2><ol><li>是否有索引</li><li>覆盖索引 <ul><li>可以避免回表操作</li></ul></li><li>避免隐式的类型转换</li><li>连表的两个字段必须保持相同的数据类型和字符集 <ul><li>有可能不能使用索引，造成全表扫描</li></ul></li><li>not exist与not in(优先选择not exist) <ul><li>not in使用不当还有可能返回错误结果。 如果not in子查询包含了null，将返回空数据。 如果not in子查询返回空数据，将匹配所有行数据</li><li>not in (1,null) : 返回空数据</li><li>not in (select 1 where 1=0) : 返回所有数据</li></ul></li><li>索引字段进行表达式或函数计算 <ul><li>会造成全表扫描</li></ul></li><li>不满足左匹配原则，比如模糊查询 <ul><li>会造成全表扫描</li></ul></li><li>!=（不等于） <ul><li>会造成全表扫描</li></ul></li><li>索引字段尽量建立在区分度高的列上 <ul><li>比如在is_del这样的字段上加索引意义就不是很大</li></ul></li><li>长字段单独一张表</li></ol><ul><li>从b+数的结构上解释，一页的空间是16kb，存放的数据占用空间越小那么一页存放的数据越多，整棵树就更加矮胖，IO次数就越少，效率越高</li></ul>`,7),y={start:"11"},A={href:"https://mp.weixin.qq.com/s/KpTG1WUlcP6cyk8Y9SMcyQ",target:"_blank",rel:"noopener noreferrer"},I=a("<li>小表驱动大表</li><li>时间排序转换为id排序</li><li>分页技巧（断点分页）</li><li>表设计时，满足要求的情况下尽量选择占用空间小的数据类型</li><li>合理适用子查询，比如in与exist，有时比连表效率更高</li><li>sql语句尽量简单（这个我的使用习惯），一些操作可以让应用层完成</li><li>聚合操作避免使用ICP（也就是聚合操作的extra列不要出现using index condition）</li><li>or</li><li>null</li><li>避免使用not in,而用not exists 替代</li>",10),w=e("h2",{id:"icp-index-condition-pushdown",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#icp-index-condition-pushdown","aria-hidden":"true"},"#"),i(" ICP(Index Condition PushDown)")],-1),R={href:"https://www.jb51.net/article/222444.htm",target:"_blank",rel:"noopener noreferrer"},N=e("h2",{id:"mysql执行计划",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#mysql执行计划","aria-hidden":"true"},"#"),i(" MySQL执行计划")],-1),x={href:"https://blog.csdn.net/horses/article/details/106905110",target:"_blank",rel:"noopener noreferrer"},q=a('<h2 id="小表驱动大表" tabindex="-1"><a class="header-anchor" href="#小表驱动大表" aria-hidden="true">#</a> 小表驱动大表</h2><h3 id="何为小表驱动大表" tabindex="-1"><a class="header-anchor" href="#何为小表驱动大表" aria-hidden="true">#</a> 何为小表驱动大表</h3><p>用小的数据集驱动大的数据集</p><h3 id="如何区分驱动表与被驱动表" tabindex="-1"><a class="header-anchor" href="#如何区分驱动表与被驱动表" aria-hidden="true">#</a> 如何区分驱动表与被驱动表</h3><p>很简单：explain 出来的结果中，第一行显示的表即为驱动表</p><h3 id="join的时候谁是驱动表" tabindex="-1"><a class="header-anchor" href="#join的时候谁是驱动表" aria-hidden="true">#</a> join的时候谁是驱动表</h3><ol><li>A left join B，则左表是驱动表，即A是驱动表</li><li>A right join B，则右表是驱动表，即B是驱动表</li><li>A inner join B，MySQL会选择比较小的表为驱动表</li></ol><h3 id="exsit与in" tabindex="-1"><a class="header-anchor" href="#exsit与in" aria-hidden="true">#</a> Exsit与In</h3><p>现在有两张表：</p><p>dept表：部门表，大概20条记录</p><p>emp表：员工表，大概1W条记录</p><p>需求：找出部门名称包含&quot;技术&quot;两个字的所有员工信息</p>',12),B={href:"http://B.name",target:"_blank",rel:"noopener noreferrer"},T={href:"http://B.name",target:"_blank",rel:"noopener noreferrer"},S=e("p",null,"先说结论：",-1),U=e("ol",null,[e("li",null,"当A表的数据集大于B表时，IN比exists更优"),e("li",null,"当A表的数据集小于B表时，exists比IN更优")],-1),M=e("p",null,"根据上面的结论，可知方案一比方案二时间更短，不信可自行实验",-1),k={href:"https://mp.weixin.qq.com/s/KpTG1WUlcP6cyk8Y9SMcyQ",target:"_blank",rel:"noopener noreferrer"},D={href:"https://blog.csdn.net/qq_38011415/article/details/103304189",target:"_blank",rel:"noopener noreferrer"},P=e("h2",{id:"哪些情况会出现全表扫描",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#哪些情况会出现全表扫描","aria-hidden":"true"},"#"),i(" 哪些情况会出现全表扫描")],-1),C=e("li",null,"数据量太小了，走索引可能成本还要高一些",-1),O=e("li",null,"筛选列没有索引",-1),j=e("li",null,"筛选列有索引，但是匹配的数据量接近于整张表数据",-1),Y=e("li",null,"筛选列有索引，但是使用方式不对，比如对列进行计算、不满足最左匹配原则",-1),F={href:"https://blog.csdn.net/horses/article/details/107243447",target:"_blank",rel:"noopener noreferrer"},X=e("h3",{id:"in-和-exist语句",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#in-和-exist语句","aria-hidden":"true"},"#"),i(" IN 和 EXIST语句")],-1),Q={href:"https://mp.weixin.qq.com/s/KpTG1WUlcP6cyk8Y9SMcyQ",target:"_blank",rel:"noopener noreferrer"},H=a(`<h2 id="use-index-与-force-index的区别" tabindex="-1"><a class="header-anchor" href="#use-index-与-force-index的区别" aria-hidden="true">#</a> use index 与 force index的区别？</h2><p>use index是告诉优化器可以使用这个索引，但最终优化器可以不用这个索引。</p><p>force index是强制让优化器使用这个索引</p><h2 id="show-index-from-库名-表名" tabindex="-1"><a class="header-anchor" href="#show-index-from-库名-表名" aria-hidden="true">#</a> show index from 库名.表名</h2><p>这条命令输出了一个关键值：cardinality，表示该索引中唯一值的数目。这个值和表总行数应该尽量接近1，否则可以考虑是否可以删除这个索引。但这个值不是实时更新的，只是一个大概值。如果要手动更新这个值，可以使用 analyze table table_name来完成。</p><p>mysql是通过采样的方法来进行统计这个值的</p><p>优化器会根据这个值来判断是否使用这个索引，但这个值可能有时候不准确，因此可能影响sql执行性能，所以可以考虑在系统非高峰时间对核心表执行analyze table操作。</p><h2 id="实际例子" tabindex="-1"><a class="header-anchor" href="#实际例子" aria-hidden="true">#</a> 实际例子</h2><ul><li>MySQL的大部分索引（PRIMARY KEY,UNIQUE,INDEX）都采用的是B-Tree数据结构</li><li>对于一些特定的数据类型，会采用R-Tree数据结构</li><li>内存表（MEMORY table）支持 哈希表 数据结构</li><li>组合索引，复合索引，联合索引，是一个东西 <ul><li>对多个列建立一个索引，如下的组合索引。</li><li>要根据业务场景来决定列的顺序。</li><li>是否能用到联合索引，要看where条件是否符合 <em><strong>最左前缀</strong></em> 原则。</li><li>组合索引的第一个字段必须出现在查询组句中，这个索引才会被用到。（和上一条一个意思）</li></ul><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>create table test(
    a int,
    b int,
    c int,
    KEY a(a,b,c)
...
dubbo-admin  	2.5.3
es				1.6.0-2.1.0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h2 id="系统推荐" tabindex="-1"><a class="header-anchor" href="#系统推荐" aria-hidden="true">#</a> 系统推荐</h2>`,20),W=e("p",null,[e("br"),e("br"),e("br"),e("br"),e("br"),e("br")],-1),G=e("hr",null,null,-1),V=e("hr",null,null,-1),K=e("ul",null,[e("li",null,[e("strong",null,"随机毒鸡汤"),i("：有人说我是猪，我觉得也就只有猪看人，才会像猪吧。 "),e("br"),e("br"),e("img",{src:"https://images.pexels.com/photos/3861976/pexels-photo-3861976.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",alt:"Extreme close-up of computer code displaying various programming terms and elements.",loading:"lazy"})])],-1);function z(J,$){const l=r("ExternalLinkIcon"),s=r("RouterLink");return c(),t("div",null,[m,e("p",null,[i("扩展阅读： "),e("a",b,[i("https://blog.csdn.net/horses/article/details/106905110"),n(l)])]),o,e("p",null,[i("使用performance_schema数据库的具体步骤参考："),e("a",p,[i("https://dev.mysql.com/doc/refman/5.7/en/performance-schema-query-profiling.html"),n(l)])]),g,e("ol",null,[e("li",null,[h,E,e("p",null,[i("这个变量的作用范围既可以是整个系统，也可以是当前会话，具体参考："),e("a",f,[i("https://dev.mysql.com/doc/refman/5.7/en/innodb-parameters.html"),n(l)])])]),_]),L,e("ol",y,[e("li",null,[i("in与exist（各有适用场景："),e("a",A,[i("in和exist的选择"),n(l)])]),I]),w,e("p",null,[e("a",R,[i("https://www.jb51.net/article/222444.htm"),n(l)])]),N,e("p",null,[e("a",x,[i("https://blog.csdn.net/horses/article/details/106905110"),n(l)])]),q,e("p",null,[i("方案一： select * from emp A where A.depNo in (select B.deptNo from dept B where "),e("a",B,[i("B.name"),n(l)]),i(" like '%技术%');")]),e("p",null,[i("方案二： select * from emp A where exists ( select 1 from dept B where B.deptNo = A.deptNo and "),e("a",T,[i("B.name"),n(l)]),i(" like '%技术%' )")]),S,U,M,e("blockquote",null,[e("p",null,[e("a",k,[i("https://mp.weixin.qq.com/s/KpTG1WUlcP6cyk8Y9SMcyQ"),n(l)]),e("a",D,[i("https://blog.csdn.net/qq_38011415/article/details/103304189"),n(l)])])]),P,e("ul",null,[C,O,j,Y,e("li",null,[e("a",F,[i("有索引，但字符集不同"),n(l)])])]),X,e("p",null,[e("a",Q,[i("in和exist的选择"),n(l)])]),H,e("ul",null,[e("li",null,[n(s,{to:"/software/unclassified/Cordova+Umi%E9%A1%B9%E7%9B%AE%E6%90%AD%E5%BB%BA%E6%AD%A5%E9%AA%A4.html"},{default:d(()=>[i("Cordova+Umi项目搭建步骤")]),_:1})]),e("li",null,[n(s,{to:"/other/%E5%85%8D%E8%B4%B9https%E8%AF%81%E4%B9%A6%E3%80%81%E8%87%AA%E5%8A%A8%E7%BB%AD%E6%9C%9F.html"},{default:d(()=>[i("免费https证书、自动续期")]),_:1})]),e("li",null,[n(s,{to:"/software/middleware/mysql/MySQL%E6%9D%82%E9%A1%B9.html"},{default:d(()=>[i("MySQL杂项")]),_:1})]),e("li",null,[n(s,{to:"/software/spring/Spring%E6%A1%86%E6%9E%B6%E6%BA%90%E7%A0%81%E5%85%B3%E9%94%AE%E7%82%B9.html"},{default:d(()=>[i("Spring框架源码关键点")]),_:1})]),e("li",null,[n(s,{to:"/software/jvm/JVM%E5%8F%82%E6%95%B0%E8%AE%BE%E7%BD%AE.html"},{default:d(()=>[i("JVM参数设置")]),_:1})]),e("li",null,[n(s,{to:"/other/PostgreSQL%E5%AE%9A%E6%97%B6%E5%A4%87%E4%BB%BD.html"},{default:d(()=>[i("PostgreSQL定时备份")]),_:1})]),e("li",null,[n(s,{to:"/other/PGSQL%20GIN%E7%B4%A2%E5%BC%95%E2%80%9C%E5%A4%B1%E6%95%88%E2%80%9D.html"},{default:d(()=>[i("PGSQL GIN索引“失效”")]),_:1})]),e("li",null,[n(s,{to:"/other/JDK8%20G1%20%E5%A0%86%E5%86%85%E5%AD%98%E5%B1%85%E7%84%B6%E4%B8%8D%E9%87%8A%E6%94%BE.html"},{default:d(()=>[i("JDK8 G1 堆内存居然不释放")]),_:1})]),e("li",null,[n(s,{to:"/software/middleware/mysql/MySQL%E9%94%81%E3%80%81%E4%BA%8B%E5%8A%A1%E3%80%81%E9%9A%94%E7%A6%BB%E7%BA%A7%E5%88%AB.html"},{default:d(()=>[i("MySQL锁、事务、隔离级别")]),_:1})]),e("li",null,[n(s,{to:"/other/PGSQL%E7%9A%84json%E5%92%8C%20jsonb%20%E8%AF%BB%E5%86%99%E6%80%A7%E8%83%BD%E6%B5%8B%E8%AF%95.html"},{default:d(()=>[i("PGSQL的json和 jsonb 读写性能测试")]),_:1})]),e("li",null,[n(s,{to:"/software/docker/Docker%E8%B7%A8%E4%B8%BB%E6%9C%BA%E9%80%9A%E4%BF%A1%E6%96%B9%E6%A1%88.html"},{default:d(()=>[i("Docker跨主机通信方案")]),_:1})]),e("li",null,[n(s,{to:"/other/Linux%20dev%20shm%E7%9B%AE%E5%BD%95.html"},{default:d(()=>[i("Linux dev shm目录")]),_:1})])]),W,G,V,K])}const ee=v(u,[["render",z],["__file","SQL优化.html.vue"]]);export{ee as default};
