...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到此，方案二结束。接下来我们来安装elk实施日志分析。</p><h2 id="在centos7上安装docker" tabindex="-1"><a class="header-anchor" href="#在centos7上安装docker" aria-hidden="true">#</a> 在centos7上安装docker</h2>`,32),p={href:"https://docs.docker.com/install/linux/docker-ce/centos/",target:"_blank",rel:"noopener noreferrer"},q=l(`<p>也可执行以下步骤：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>移除旧版本：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到此，elk服务准备好了，下一步使用filebeat搜集日志。</p><h2 id="安装filebeat" tabindex="-1"><a class="header-anchor" href="#安装filebeat" aria-hidden="true">#</a> 安装filebeat</h2><p>下面需要在日志所在的机子上安装filebeat。</p>`,27),h={href:"https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-installation.html",target:"_blank",rel:"noopener noreferrer"},x=l(`<p>因为这里是centos 7系统，我的安装步骤是：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>curl -L -O https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-5.4.3-x86_64.rpm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),f={href:"https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-starting.html",target:"_blank",rel:"noopener noreferrer"},k=l(`<p>我这里执行以下命令：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>启动：
sudo /etc/init.d/filebeat start 

停止：
sudo /etc/init.d/filebeat stop
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上步骤搞定后，就可以爽歪歪的使用 kibana了。</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629081592042.jpg" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><br><br><br><h2 id="系统推荐" tabindex="-1"><a class="header-anchor" href="#系统推荐" aria-hidden="true">#</a> 系统推荐</h2>`,8),_={href:"http://xn--Mermaid-mf6kt76ck2kz44e.md",target:"_blank",rel:"noopener noreferrer"},y={href:"http://System.md",target:"_blank",rel:"noopener noreferrer"},j={href:"http://xn--JSON-eo6fm74boogqmgk7qdjqkqyz8t.md",target:"_blank",rel:"noopener noreferrer"},A={href:"http://xn--yfrq2b7zsrkndid5y6d.md",target:"_blank",rel:"noopener noreferrer"},S={href:"http://Demo.md",target:"_blank",rel:"noopener noreferrer"},E=e("p",null,[e("br"),e("br"),e("br"),e("br"),e("br"),e("br")],-1),w=e("hr",null,null,-1),T=e("hr",null,null,-1),M=e("ul",null,[e("li",null,[e("strong",null,"随机毒鸡汤"),i("：喜欢你的时候夸你聪明，不喜欢你的时候，又嫌你太聪明。 "),e("br"),e("br"),e("img",{src:"https://tuapi.eees.cc/api.php?category=biying&type=302&uuid=fcd76004-d20b-4788-ae11-a42dea2a03de",alt:"",loading:"lazy"})])],-1);function C(N,z){const s=a("ExternalLinkIcon"),t=a("RouterLink");return u(),o("div",null,[c,e("p",null,[i("这样更改后，通过filebeat的multiline解决了日志分割的问题。 下面需要解决日志json化的问题：关键点：grok表达式。 这个表达式的学习完全没有必要从头开始学或者系统的学习，我完全是依葫芦画瓢学习的。这里举一个非常简单的例子体验一下： 网址："),e("a",m,[i("http://grokdebug.herokuapp.com/"),n(s)]),i(" 或者 "),e("a",b,[i("http://grok.elasticsearch.cn/"),n(s)]),i(" 在input输入：")]),g,e("p",null,[i("可参照官网安装步骤："),e("a",p,[i("https://docs.docker.com/install/linux/docker-ce/centos/"),n(s)])]),q,e("p",null,[i("安装方法可以参照官网： "),e("a",h,[i("https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-installation.html"),n(s)])]),x,e("p",null,[i("启动filebeat: 不同系统的启动方法有所不同，具体可以参照官网： "),e("a",f,[i("https://www.elastic.co/guide/en/beats/filebeat/5.4/filebeat-starting.html"),n(s)])]),k,e("ul",null,[e("li",null,[i("[Markdown Mermaid画图实例](../../unclassified/Markdown "),e("a",_,[i("Mermaid画图实例.md"),n(s)]),i(")")]),e("li",null,[i("[Cornell Notes System](../../../other/Cornell Notes "),e("a",y,[i("System.md"),n(s)]),i(")")]),e("li",null,[n(t,{to:"/other/Arthas%E4%BD%BF%E7%94%A8%E8%AE%B0%E5%BD%95.html"},{default:d(()=>[i("Arthas使用记录")]),_:1})]),e("li",null,[n(t,{to:"/other/Nginx%E7%9A%84%E5%8F%8C%E5%90%91%E8%AE%A4%E8%AF%81%E9%85%8D%E7%BD%AE.html"},{default:d(()=>[i("Nginx的双向认证配置")]),_:1})]),e("li",null,[i("[PostgreSQL JSON类型字段常用操作](../../../other/PostgreSQL "),e("a",j,[i("JSON类型字段常用操作.md"),n(s)]),i(")")]),e("li",null,[i("[vuepress-theme-hope 添加谷歌广告](../../../other/vuepress-theme-hope "),e("a",A,[i("添加谷歌广告.md"),n(s)]),i(")")]),e("li",null,[n(t,{to:"/software/unclassified/%E8%A1%A8%E5%8D%95%E9%87%8D%E5%A4%8D%E6%8F%90%E4%BA%A4%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88.html"},{default:d(()=>[i("表单重复提交解决方案")]),_:1})]),e("li",null,[i("[WebSocket SpringBoot Demo](../../../other/WebSocket SpringBoot "),e("a",S,[i("Demo.md"),n(s)]),i(")")])]),E,w,T,M])}const L=r(v,[["render",C],["__file","搭建基于docker的elk平台来分析java日志.html.vue"]]);export{L as default};
