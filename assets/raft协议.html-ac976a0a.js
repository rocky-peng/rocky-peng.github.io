import{_ as n,$ as a,a0 as d,a1 as e,a2 as l,a3 as r,a4 as s,w as t}from"./framework-294a1fec.js";const c={},o=e("h2",{id:"raft动画解说",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#raft动画解说","aria-hidden":"true"},"#"),l(" RAFT动画解说")],-1),v={href:"http://thesecretlivesofdata.com/raft/",target:"_blank",rel:"noopener noreferrer"},u=s(`<ol><li>是一种复制状态机，是一种能让分布式系统中各个节点达成共识的一套框架协议或者算法</li><li>主要有两个过程 <ul><li>leader选举过程</li><li>日志复制过程</li></ul></li><li>一个共三种角色，leader/follower/candidate</li><li>满足的是CAP中的CP，和zk一样，zk也是CP，也是在leader选举过程中不可用</li></ol><h2 id="leader选举过程" tabindex="-1"><a class="header-anchor" href="#leader选举过程" aria-hidden="true">#</a> leader选举过程</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. 最开始各个节点均已follower角色启动，并各自机出一个超时时间，这个超时时间称之为 election timeout. 一般在150ms-300ms之间
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>WAL: 什么叫WAL，全称Write Ahead Log，也就是同一个事务的数据，日志的数据必须先于最终的数据落盘</li></ul><br>`,7),m=e("p",null,[e("br"),e("br"),e("br"),e("br"),e("br"),e("br")],-1),b=e("hr",null,null,-1),h=e("hr",null,null,-1),_=e("ul",null,[e("li",null,[e("strong",null,"随机毒鸡汤"),l("：在房间玩腻了，准备去客厅散散心，过几天去厨房走走。 "),e("br"),e("br"),e("img",{src:"https://tuapi.eees.cc/api.php?category=fengjing&type=302&uuid=8bbdc317-3ac1-4321-ac34-59cba7e2969a",alt:"",loading:"lazy"})])],-1);function p(f,g){const i=t("ExternalLinkIcon");return a(),d("div",null,[o,e("p",null,[e("a",v,[l("http://thesecretlivesofdata.com/raft/"),r(i)])]),u,l(" ## 系统推荐 - [Git笔记](../unclassified/Git笔记.md) - [JVM垃圾收集器](../jvm/JVM垃圾收集器.md) - [Git合并多个提交并push到远程仓库](../../other/Git合并多个提交并push到远程仓库.md) - [是时候使用MapStruct替代BeanUtils了](../../other/是时候使用MapStruct替代BeanUtils了.md) - [分库分表](../middleware/mysql/分库分表.md) - [Docker跨主机通信方案](../docker/Docker跨主机通信方案.md) - [SpringCloud总体认识](../spring/SpringCloud总体认识.md) - [随机图片在线接口](../../other/随机图片在线接口.md) "),m,b,h,_])}const A=n(c,[["render",p],["__file","raft协议.html.vue"]]);export{A as default};
