import{_ as a,$ as e,a0 as i,a2 as n,a4 as l,a1 as s}from"./framework-294a1fec.js";const r={},c=l(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token function">git</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br>`,7),t=s("p",null,[s("br"),s("br"),s("br"),s("br"),s("br"),s("br")],-1),d=s("hr",null,null,-1),o=s("hr",null,null,-1),p=s("ul",null,[s("li",null,[s("strong",null,"随机毒鸡汤"),n("：物以类聚人以穷分，有钱人终成眷属。 "),s("br"),s("br"),s("img",{src:"https://tuapi.eees.cc/api.php?category=fengjing&type=302&uuid=e4aed362-4200-4fa9-ab3e-79a9500606b8",alt:"",loading:"lazy"})])],-1);function v(b,u){return e(),i("div",null,[c,n(" ## 系统推荐 - [JVM参数设置](../jvm/JVM参数设置.md) - [ShadowsockServer](../shodowsocks/ShadowsockServer.md) - [Redis高可用](../../other/Redis高可用.md) - [linux_no_space_left_on_device](linux_no_space_left_on_device.md) - [JetBrains-License-Server](../../other/JetBrains-License-Server.md) - [sofajraft](../raft/sofajraft.md) - [WebSocket SpringBoot Demo](../../other/WebSocket SpringBoot Demo.md) - [K8S常用命令](../../other/K8S常用命令.md) "),t,d,o,p])}const h=a(r,[["render",v],["__file","Oh My ZSH.html.vue"]]);export{h as default};
