...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629084459843.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><h3 id="准备es的索引模板" tabindex="-1"><a class="header-anchor" href="#准备es的索引模板" aria-hidden="true">#</a> 准备es的索引模板</h3><p>在 tfs 中已经准备了几个我们生产环境使用的es索引模板，可根据自身情况自行修改</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629363123202.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><p>由于索引模板是yml格式的，需要转换为json格式：通过修改index.sh中的相关参数并执行index.sh即可完成json转换。</p><p>index.sh完成了两个动作（可根据自身情况自行删除）： - yml转换为json - 连接es创建索引</p><h3 id="准备测试数据" tabindex="-1"><a class="header-anchor" href="#准备测试数据" aria-hidden="true">#</a> 准备测试数据</h3><p>在tfs中也已经准备好了生成测试数据的工具</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629363176507.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><p>只需要修改eslog_generator.sh中的三个参数即可根据索引模板生产测试数据</p><h3 id="编辑track-json文件" tabindex="-1"><a class="header-anchor" href="#编辑track-json文件" aria-hidden="true">#</a> 编辑track.json文件</h3><p>这个文件是esrally需要使用的，可参考：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629363008361.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><h3 id="执行" tabindex="-1"><a class="header-anchor" href="#执行" aria-hidden="true">#</a> 执行</h3><p>track.json文件和生成的数据文件要放在同一个目录，假设为 /opt/esrally/track，则执行</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>esrally race <span class="token parameter variable">--pipeline</span><span class="token operator">=</span>benchmark-only --track-path<span class="token operator">=</span>/opt/esrally/track --target-hosts<span class="token operator">=</span>esip:9200
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>执行完成会有下面的一个结果输出</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629084523817.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><br><h2 id="系统推荐" tabindex="-1"><a class="header-anchor" href="#系统推荐" aria-hidden="true">#</a> 系统推荐</h2>`,23),k=n("p",null,[n("br"),n("br"),n("br"),n("br"),n("br"),n("br")],-1),b=n("hr",null,null,-1),h=n("hr",null,null,-1),g=n("ul",null,[n("li",null,[n("strong",null,"随机毒鸡汤"),s("：当金钱站起来说话时，所有真理都沉默了。 "),n("br"),n("br"),n("img",{src:"https://tuapi.eees.cc/api.php?category=biying&type=302&uuid=9d0348d1-61e9-4f14-9d98-3227d11f628c",alt:"",loading:"lazy"})])],-1);function y(q,E){const p=i("ExternalLinkIcon"),e=i("RouterLink");return c(),u("div",null,[d,n("p",null,[s("esrally是es官方提供的对es进行性能测试的工具 官网："),n("a",v,[s("https://esrally.readthedocs.io/en/stable/quickstart.html"),a(p)])]),m,n("ul",null,[n("li",null,[a(e,{to:"/software/java-basic/synchronized%E5%8E%9F%E7%90%86%E6%B7%B1%E5%BA%A6%E5%89%96%E6%9E%90.html"},{default:t(()=>[s("synchronized原理深度剖析")]),_:1})]),n("li",null,[a(e,{to:"/other/K8S%20%E6%97%A0%E6%84%9F%E5%8F%91%E5%B8%83.html"},{default:t(()=>[s("K8S 无感发布")]),_:1})]),n("li",null,[a(e,{to:"/other/Censys%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%AD%A6%E4%B9%A0.html"},{default:t(()=>[s("Censys搜索引擎学习")]),_:1})]),n("li",null,[a(e,{to:"/software/middleware/mq/kafka.html"},{default:t(()=>[s("kafka")]),_:1})]),n("li",null,[a(e,{to:"/software/middleware/mysql/InnoDB%E5%AD%98%E5%82%A8%E5%BC%95%E6%93%8E.html"},{default:t(()=>[s("InnoDB存储引擎")]),_:1})]),n("li",null,[a(e,{to:"/software/java-basic/%E4%B8%8D%E9%87%8D%E5%90%AF%20JVM%EF%BC%8C%E5%A6%82%E4%BD%95%E6%9B%BF%E6%8D%A2%E6%8E%89%E5%B7%B2%E7%BB%8F%E5%8A%A0%E8%BD%BD%E7%9A%84%E7%B1%BB%EF%BC%9F.html"},{default:t(()=>[s("不重启 JVM，如何替换掉已经加载的类？")]),_:1})]),n("li",null,[a(e,{to:"/other/PGSQL%E7%9A%84json%E5%92%8C%20jsonb%20%E8%AF%BB%E5%86%99%E6%80%A7%E8%83%BD%E6%B5%8B%E8%AF%95.html"},{default:t(()=>[s("PGSQL的json和 jsonb 读写性能测试")]),_:1})]),n("li",null,[a(e,{to:"/other/Lombok%E7%9A%84Accessors%E5%AF%BC%E8%87%B4EasyExcel%E8%AF%BB%E5%8F%96%E5%A4%B1%E8%B4%A5.html"},{default:t(()=>[s("Lombok的Accessors导致EasyExcel读取失败")]),_:1})]),n("li",null,[a(e,{to:"/software/middleware/mq/RocketMQ.html"},{default:t(()=>[s("RocketMQ")]),_:1})]),n("li",null,[a(e,{to:"/other/PostgreSQL%20JSON%E7%B1%BB%E5%9E%8B%E5%AD%97%E6%AE%B5%E5%B8%B8%E7%94%A8%E6%93%8D%E4%BD%9C.html"},{default:t(()=>[s("PostgreSQL JSON类型字段常用操作")]),_:1})]),n("li",null,[a(e,{to:"/other/SpringBoot%E6%9C%8D%E5%8A%A1%E5%9C%A8%E6%9C%8D%E5%8A%A1%E5%90%AF%E5%8A%A8%E5%AE%8C%E6%88%90%E5%89%8D%E8%A2%AB%E6%8F%90%E5%89%8D%E6%B3%A8%E5%86%8C%E5%88%B0nacos.html"},{default:t(()=>[s("SpringBoot服务在服务启动完成前被提前注册到nacos")]),_:1})]),n("li",null,[a(e,{to:"/other/%E9%9A%8F%E6%9C%BA%E5%9B%BE%E7%89%87%E5%9C%A8%E7%BA%BF%E6%8E%A5%E5%8F%A3.html"},{default:t(()=>[s("随机图片在线接口")]),_:1})])]),k,b,h,g])}const x=o(r,[["render",y],["__file","ESRally性能测试步骤.html.vue"]]);export{x as default};
