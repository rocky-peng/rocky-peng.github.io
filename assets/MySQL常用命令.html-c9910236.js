import{_ as n,$ as e,a0 as i,a3 as s}from"./framework-c6956f55.js";const a={},d=s(`<h2 id="常用语句" tabindex="-1"><a class="header-anchor" href="#常用语句" aria-hidden="true">#</a> 常用语句</h2><h3 id="select语句" tabindex="-1"><a class="header-anchor" href="#select语句" aria-hidden="true">#</a> SELECT语句</h3><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>当前登录用户
select user();
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><br><br><br><br><br><br></p><hr><hr><ul><li><strong>随机毒鸡汤</strong>：梦想就像天上的星星，以前看得到摸不到，现在既看不到也摸不到。 <br><br><img src="https://tuapi.eees.cc/api.php?category=fengjing&amp;type=302&amp;uuid=ce148a8a-a926-4cb9-8f9a-2268f076e27d" alt="" loading="lazy"></li></ul>`,79),l=[d];function r(v,c){return e(),i("div",null,l)}const u=n(a,[["render",r],["__file","MySQL常用命令.html.vue"]]);export{u as default};
