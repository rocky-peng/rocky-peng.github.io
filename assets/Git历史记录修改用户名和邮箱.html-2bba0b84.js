import{_ as s,$ as n,a0 as a,a3 as e}from"./framework-24d1f903.js";const t={},i=e(`<ol><li><p>进入仓库目录，执行</p><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">#!/bin/sh</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ol><p><br><br><br><br><br><br></p><hr><hr><ul><li><strong>随机毒鸡汤</strong>：那些拧不开瓶盖的女人，都是装的，你让她拆个快递试试。 <br><br><img src="https://api.btstu.cn/sjbz/?lx=suiji&amp;uuid=4de526c0-e546-41ec-b8b9-c176791003d8" alt="" loading="lazy"></li></ul>`,5),l=[i];function o(r,p){return n(),a("div",null,l)}const d=s(t,[["render",o],["__file","Git历史记录修改用户名和邮箱.html.vue"]]);export{d as default};
