import{_ as p,$ as o,a0 as l,a1 as n,a2 as a,a3 as e,a4 as t,w as i}from"./framework-294a1fec.js";const r={},c=t(`<p>生产环境下 jvm 参数建议加上下面的这些参数：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>jdk <span class="token operator">&lt;</span> <span class="token number">8</span>:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),u=n("img",{src:"https://cdn.justdopay.com/xiaoshujiang/1629079237565.png",alt:"引用自：http://www.oracle.com/technetwork/cn/community/developer-day/2-jvm-tuning-1866448-zhs.pdf",tabindex:"0",loading:"lazy"},null,-1),d={href:"http://www.oracle.com/technetwork/cn/community/developer-day/2-jvm-tuning-1866448-zhs.pdf",target:"_blank",rel:"noopener noreferrer"},v=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>minor gc: 就是针对青年代的gc
major gc: 针对老年代的gc
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>分别用jdk7,8跑程序，用jvisualvm（jdk8版本）查看： 用jdk7跑：</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629079247853.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure><p>用jdk8跑：</p><figure><img src="https://cdn.justdopay.com/xiaoshujiang/1629079254277.png" alt="enter description here" tabindex="0" loading="lazy"><figcaption>enter description here</figcaption></figure>`,5),m={href:"http://blog.csdn.net/zhyhang/article/details/17246223",target:"_blank",rel:"noopener noreferrer"},k=t('<hr><p>哪些情况下会触发Minor GC:</p><ol><li>Eden满，或者新创建的对象大小&gt;Eden所剩空间</li><li>设置了 -XX:+ScavengeBeforeFullGC 参数，在Full GC前会触发 minor gc.</li><li>设置了 -XX:+CMSScavengeBeforeRemark 参数。如果采用了cms收集器，在执行cms gc的remark阶段前会执行 minor gc</li></ol><hr><p>看了上面的major gc 与 full gc的区别，建议没必要去纠结这个东西。记住下面几点即可</p><p>Full GC</p><ol><li>Full GC == Major GC指的是对老年代/永久代的stop the world的GC</li><li>Full GC的次数 = 老年代GC时 stop the world的次数</li><li>Full GC的时间 = 老年代GC时 stop the world的总时间</li><li>CMS 不等于Full GC，我们可以看到CMS分为多个阶段，只有stop the world的阶段被计算到了Full GC的次数和时间，而和业务线程并发的GC的次数和时间则不被认为是Full GC</li></ol><hr><p>哪些情况下会触发Full GC:</p><ol><li>执行 jmap -histo:live pid</li><li>老年代满</li></ol><p>注意：</p><ol><li>在gc日志如果没有看到 Full GC 字样，也并不代表没有发生 Full GC.就好比cms gc的情况。</li><li>cms gc执行一次，full gc的次数会加2,可以通过jstat命令查看full gc的次数</li></ol><hr><h2 id="jit" tabindex="-1"><a class="header-anchor" href="#jit" aria-hidden="true">#</a> JIT</h2><h4 id="xx-compilethreshold-10000" tabindex="-1"><a class="header-anchor" href="#xx-compilethreshold-10000" aria-hidden="true">#</a> -XX:CompileThreshold=10000</h4><p>Number of method invocations/branches before compiling [-client: 1,500] 方法被JVM进行JIT编译的阈值。如果某个方法被调用了这么多次，会触发这个方法的jit编译</p><h2 id="杂项" tabindex="-1"><a class="header-anchor" href="#杂项" aria-hidden="true">#</a> 杂项</h2><h4 id="xx-omitstacktraceinfastthrow" tabindex="-1"><a class="header-anchor" href="#xx-omitstacktraceinfastthrow" aria-hidden="true">#</a> -XX:+OmitStackTraceInFastThrow</h4><p>对于一些频繁抛出的异常，JDK为了性能会做一个优化，在JIT重新编译后会抛出没有堆栈的异常。 启用，则表明使用这个优化</p><h2 id="其他参数" tabindex="-1"><a class="header-anchor" href="#其他参数" aria-hidden="true">#</a> 其他参数</h2>',20),b={href:"http://www.oracle.com/technetwork/java/javase/tech/vmoptions-jsp-140102.html",target:"_blank",rel:"noopener noreferrer"},g=n("br",null,null,-1),h=n("p",null,[n("br"),n("br"),n("br"),n("br"),n("br"),n("br")],-1),X=n("hr",null,null,-1),f=n("hr",null,null,-1),C=n("ul",null,[n("li",null,[n("strong",null,"随机毒鸡汤"),a("：你若不是可有可无，他又怎会忽冷忽热。 "),n("br"),n("br"),n("img",{src:"https://tuapi.eees.cc/api.php?category=fengjing&type=302&uuid=5d739c34-e902-4c98-9896-2cccb30e655a",alt:"",loading:"lazy"})])],-1);function S(j,G){const s=i("ExternalLinkIcon");return o(),l("div",null,[c,n("figure",null,[u,n("figcaption",null,[a("引用自："),n("a",d,[a("http://www.oracle.com/technetwork/cn/community/developer-day/2-jvm-tuning-1866448-zhs.pdf"),e(s)])])]),v,n("p",null,[a("可以看出，jdk8和jdk7在堆布局上相似，jdk中的permanent generation没有了，换成了metaspace。两者更详细的差异可以参考："),n("a",m,[a("http://blog.csdn.net/zhyhang/article/details/17246223"),e(s)])]),k,n("p",null,[a("详见："),n("a",b,[a("http://www.oracle.com/technetwork/java/javase/tech/vmoptions-jsp-140102.html"),e(s)])]),g,a(" ## 系统推荐 - [Oh My ZSH](../unclassified/Oh My ZSH.md) - [getPath vs getAbsolutePath vs getCanonicalPath](../../other/getPath vs getAbsolutePath vs getCanonicalPath.md) - [MAT工具](../unclassified/MAT工具.md) - [Nacos-Spring Gateway-Spring boot无感发布](../../other/Nacos-Spring Gateway-Spring boot无感发布.md) - [你真的会拼接字符串吗？](../../other/你真的会拼接字符串吗？.md) - [高可用通用方案](../../other/高可用通用方案.md) - [Flutter开发需要涉及的知识点大纲](../unclassified/Flutter开发需要涉及的知识点大纲.md) - [WebSocket SpringBoot Demo](../../other/WebSocket SpringBoot Demo.md) "),h,X,f,C])}const F=p(r,[["render",S],["__file","JVM参数设置.html.vue"]]);export{F as default};
