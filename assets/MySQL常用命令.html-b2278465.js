import{_ as l,$ as d,a0 as r,a1 as n,a3 as s,a4 as a,a5 as v,a2 as e,w as c}from"./framework-b7a22294.js";const t={},u=v(`<h2 id="常用语句" tabindex="-1"><a class="header-anchor" href="#常用语句" aria-hidden="true">#</a> 常用语句</h2><h3 id="select语句" tabindex="-1"><a class="header-anchor" href="#select语句" aria-hidden="true">#</a> SELECT语句</h3><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>当前登录用户
select user();
