...
![](https://cdn.justdopay.com/pasteimageintomarkdown/2022-09-15/672530677409300.png)

点击上图中的outgoing，显示如下：

![](https://cdn.justdopay.com/pasteimageintomarkdown/2022-09-15/673448888968000.png)

可以看到红框中的字段就是Thread类中有的字段名，所以outgoing显示的是这个对象引用了哪些对象
